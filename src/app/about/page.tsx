    ...
    <div className="bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors duration-300">
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-slate-900 dark:text-white mb-8 leading-tight">
              Transforming Ideas into <span className="text-blue-700 dark:text-blue-300">Modern Digital Products</span>
            </h1>
      ...
      <section className="py-20 container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
            className="p-8 sm:p-10 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex flex-col justify-between"
          >
            <div>
               <div className="p-3.5 rounded-xl bg-slate-900 text-white w-fit mb-6">
                 <Eye className="h-7 w-7" />
               </div>
               <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white mb-4">Company Vision</h2>
          ...
          >
            <div>
               ...
               <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white mb-4">Company Mission</h2>
              <p className="text-slate-600 dark:text-slate-300 text-base leading-relaxed italic">
      ...
      <section className="py-16 bg-slate-900 text-white">
        <div className="container mx-auto px-6 max-w-4xl text-center">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">Explore Our Real Products & Solutions</h2>
      ...
      <section className="py-20 bg-slate-50 dark:bg-slate-900/50 border-y border-slate-200 dark:border-slate-800">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="text-center mb-16">
            <span className="text-xs font-semibold text-blue-700 dark:text-blue-300 tracking-wide bg-blue-50 dark:bg-blue-900/30 px-3 py-1 rounded-full border border-blue-100 dark:border-blue-800">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {customServices.map((service, idx) => (
              <div key={idx} className="p-5 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex items-center space-x-3">
      ...
      <section className="py-20 container mx-auto px-6">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <span className="text-xs font-semibold text-indigo-700 dark:text-indigo-300 tracking-wide bg-indigo-50 dark:bg-indigo-900/30 px-3 py-1 rounded-full border border-indigo-100 dark:border-indigo-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          {devApproach.map((step, idx) => (
            <div key={idx} className="p-6 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-4">
                  <span className="text-xs font-medium text-blue-700 dark:text-blue-300 bg-blue-50 dark:bg-blue-900/30 px-2.5 py-1 rounded-md">
                    {step.num}
                  </span>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {whyChooseUs.map((item, idx) => (
              <div key={idx} className="p-8 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800">
                <div className="p-3.5 rounded-xl bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 w-fit mb-6">
      ...
      <section className="py-20 container mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center gap-12 max-w-5xl mx-auto">
          <div className="flex-1">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs font-medium tracking-wide mb-4">
            ...
            <div className="flex items-center space-x-4 mb-8 p-4 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
              ...
              <div>
                <h4 className="font-semibold text-lg text-slate-900 dark:text-white">Rahul Kumar Yadav</h4>
                <p className="text-blue-600 dark:text-blue-400 font-medium text-xs tracking-wider">CEO / FOUNDER</p>
              </div>
            </div>

            <button 
              onClick={scrollToTeam}
              className="px-7 py-3.5 rounded-lg bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-medium text-sm hover:bg-slate-800 dark:hover:bg-slate-100 transition-colors flex items-center gap-2"
            >
              <Users2 className="h-4 w-4" />
          ...
          <div className="flex-1 relative w-full max-w-sm sm:max-w-md">
            <div className="aspect-square rounded-xl overflow-hidden shadow-lg border-2 border-white dark:border-slate-800 relative">
              <Image src="/ceo.png" alt="Rahul Kumar Yadav - CEO of ZAYA CODE HUB" fill className="object-cover" />
            </div>
            <div className="absolute -bottom-6 -left-6 p-6 rounded-xl bg-white dark:bg-slate-900 shadow-md border border-slate-200 dark:border-slate-800">
              <div className="text-3xl font-bold text-blue-600 dark:text-blue-400">6+</div>
              <div className="text-xs font-medium text-slate-700 dark:text-slate-300 uppercase tracking-wider">Flagship Products</div>
            </div>
          </div>
        </div>
      </section>
