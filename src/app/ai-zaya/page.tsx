...
export default function AiZayaPage() {
  ...
  const keyFeatures = [
    ...
    {
      icon: <Gamepad2 className="h-7 w-7 text-purple-600 dark:text-purple-400" />,
    ...
    {
      icon: <Globe className="h-7 w-7 text-emerald-600 dark:text-emerald-400" />,
    ...
    {
      icon: <Code className="h-7 w-7 text-cyan-600 dark:text-cyan-400" />,
    ...
    {
      icon: <PenTool className="h-7 w-7 text-rose-600 dark:text-rose-400" />,
    ...
    {
      icon: <Lightbulb className="h-7 w-7 text-yellow-600 dark:text-yellow-400" />,
    ...
    {
      icon: <Mic className="h-7 w-7 text-indigo-600 dark:text-indigo-400" />,
    ...
    {
      icon: <Sliders className="h-7 w-7 text-teal-600 dark:text-teal-400" />,
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 pt-8 pb-20 selection:bg-blue-600 selection:text-white transition-colors duration-300">
      ...
      {/* Hero Section */}
      <section className="relative container mx-auto px-6 pt-8 pb-16">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          
          <div className="flex-1 max-w-2xl text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-600/10 border border-blue-500/20 dark:border-blue-500/30 text-blue-600 dark:text-blue-400 text-sm font-bold mb-6">
              <Sparkles className="h-4 w-4 animate-pulse text-amber-500" />
              <span>DEVELOPED BY ZAYA CODE HUB</span>
            </div>

            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 dark:text-white leading-[1.12] mb-4">
              AI ZAYA <br />
            ...
            <p className="text-xl sm:text-2xl font-semibold text-blue-600 dark:text-blue-400 mb-6 italic tracking-wide">
            ...
            {/* Quick Specs */}
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 text-sm text-slate-600 dark:text-slate-400 border-t border-slate-200 dark:border-slate-800/80 pt-6">
              <div className="flex items-center gap-1">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="h-4 w-4 fill-amber-400 text-amber-400" />
                ))}
                <span className="font-bold text-slate-900 dark:text-white ml-2">4.9 Rating</span>
              </div>
      ...
      <section className="py-8 bg-slate-100/80 dark:bg-gradient-to-r dark:from-blue-950/60 dark:via-slate-900 dark:to-purple-950/60 border-y border-slate-200 dark:border-slate-800/80">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div className="p-4 rounded-xl bg-white dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800 shadow-sm">
              <div className="text-2xl font-extrabold text-blue-600 dark:text-blue-400">50+</div>
              <div className="text-xs text-slate-600 dark:text-slate-400 mt-1 font-semibold uppercase">Languages Supported</div>
            </div>
            <div className="p-4 rounded-xl bg-white dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800 shadow-sm">
              <div className="text-2xl font-extrabold text-purple-600 dark:text-purple-400">9-in-1</div>
              <div className="text-xs text-slate-600 dark:text-slate-400 mt-1 font-semibold uppercase">AI Assistant Modules</div>
            </div>
            <div className="p-4 rounded-xl bg-white dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800 shadow-sm">
              <div className="text-2xl font-extrabold text-emerald-600 dark:text-emerald-400">24/7</div>
              <div className="text-xs text-slate-600 dark:text-slate-400 mt-1 font-semibold uppercase">Voice & Text Interaction</div>
            </div>
            <div className="p-4 rounded-xl bg-white dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800 shadow-sm">
              <div className="text-2xl font-extrabold text-amber-600 dark:text-amber-400">100%</div>
              <div className="text-xs text-slate-600 dark:text-slate-400 mt-1 font-semibold uppercase">Free to Install</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 container mx-auto px-6">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-900 dark:text-white mt-4 mb-4">
            Key Features of <span className="text-blue-600 dark:text-blue-400">AI ZAYA</span>
          </h2>
          ...
          {keyFeatures.map((f, index) => (
            ...
            >
              <div>
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-1">{f.title}</h3>
                <div className="text-xs font-bold text-blue-600 dark:text-blue-400 uppercase tracking-wider mb-4">{f.subtitle}</div>
                <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed mb-6">{f.description}</p>
              </div>

              <div className="border-t border-slate-100 dark:border-slate-800/80 pt-4 space-y-2">
                {f.bullets.map((b, i) => (
                  <div key={i} className="flex items-center text-xs text-slate-600 dark:text-slate-400 gap-2">
      ...
      <section className="py-16 bg-gradient-to-r from-purple-500/10 via-indigo-500/10 to-blue-500/10 dark:from-purple-950/40 dark:via-slate-900 dark:to-indigo-950/40 border-y border-purple-200 dark:border-purple-800/30">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-8 justify-between">
            <div className="flex-1">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-500/10 border border-purple-500/20 dark:border-purple-500/30 text-purple-700 dark:text-purple-300 text-xs font-bold uppercase mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {["Memory Challenges", "Logical Reasoning", "Word Games", "Pattern Recognition", "Math Puzzles", "Concentration"].map((game, idx) => (
                  <span key={idx} className="text-xs bg-white dark:bg-purple-900/40 text-purple-800 dark:text-purple-200 border border-purple-200 dark:border-purple-700/40 px-3 py-1.5 rounded-xl font-semibold shadow-sm">
                    🎮 {game}
                  </span>
                ))}
              </div>
            ...
            <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-purple-200 dark:border-purple-500/30 text-center w-full md:w-auto shrink-0 shadow-lg">
              <div className="text-4xl mb-2">🧠⚡</div>
              <div className="text-lg font-bold text-slate-900 dark:text-white">Brain-Training AI</div>
              <div className="text-xs text-purple-700 dark:text-purple-300 mt-1">Hints, Feedback & Error Guidance</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 container mx-auto px-6">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <span className="text-xs font-bold text-purple-600 dark:text-purple-400 uppercase tracking-widest bg-purple-500/10 px-3 py-1 rounded-full border border-purple-500/20">
            UNIVERSAL ACCESSIBILITY
          </span>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 dark:text-white mt-4 mb-4">
            Who Can Use <span className="text-purple-600 dark:text-purple-400">AI ZAYA</span>?
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {targetAudiences.map((aud, index) => (
            <div key={index} className="p-6 rounded-2xl bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 shadow-sm">
              <div className="text-3xl mb-3">{aud.emoji}</div>
              <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">{aud.role}</h3>
              <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">{aud.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50 dark:bg-slate-900/50 border-t border-slate-200 dark:border-slate-800">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 dark:border-blue-500/30 text-blue-600 dark:text-blue-400 text-xs font-bold uppercase mb-4">
            ...
            <div className="p-8 rounded-3xl bg-white dark:bg-gradient-to-br dark:from-slate-900 dark:to-slate-950 border border-slate-200 dark:border-blue-500/30 shadow-md dark:shadow-xl">
              ...
              <h4 className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-3">Future Roadmap Capabilities:</h4>
      ...
      <div className="text-center pt-8 border-t border-slate-200 dark:border-slate-800/80">
        <p className="text-lg font-bold text-slate-900 dark:text-white">AI ZAYA — Learn. Think. Create. Communicate.</p>
        <p className="text-sm text-slate-600 dark:text-slate-400 mt-1 font-semibold">Developed by ZAYA CODE HUB.</p>
      </div>
    </div>
  );
}
